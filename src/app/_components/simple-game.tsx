type SimpleGameProps = {};

export default function SimpleGame({}: SimpleGameProps) {
  return (
    <div className="relative w-full md:w-5/12 flex flex-col justify-start items-start gap-16 md:gap-24">
      <div
        className="absolute right-1 z-40 pr-8 animate-opacity opacity-100"
        // style="top: -2.5rem;"
      >
        <div className="flex flex-row items-start justify-center space-x-0.5">
          <p className="font-medium text-sm text-primary animate-wiggle">
            Tick habits...
          </p>
          <svg
            viewBox="0 0 68 77"
      ...
      <div className="card w-full  bg-base-100 duration-500 ease-in-out ">
        <div className="card-body flex-row p-6">
          <div
            // style="margin-bottom: 0px;"
            className="flex-1 card-title m-0 text-ellipsis overflow-hidden font-extrabold tracking-tight "
          >
            Workout 💪
          </div>
          <div className="flex-none">
            <button
              className="btn btn-sm btn-square border-2 bg-base-100 hover:bg-base-100 duration-200 ease-in-out text-gray-500 border-gray-500 hover:border-gray-500 dark:text-gray-400 dark:border-gray-400 dark:hover:border-gray-400"
              aria-label="Tick habit"
            >
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
                data-icon="check"
                className="svg-inline--fa fa-check w-6 h-6 duration-200 ease-in-out opacity-0"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
      ...
      <div
        className="absolute left-40 z-40 pr-8 duration-200 opacity-0 scale-50 "
        // style="bottom: 4.5rem;"
      >
        <div className="flex flex-row items-start justify-center space-x-0.5">
          <svg
            viewBox="0 0 68 77"
            xmlns="http://www.w3.org/2000/svg"
            className="w-10 h-12 fill-current pt-3 text-base-content"
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
      ...
      <div className="card bg-base-100 w-full  border border-dashed border-gray-300 dark:border-gray-700 ">
        <div className="grid grid-cols-6 gap-0">
          <div className="h-16 text-3xl  cursor-default flex justify-center items-center outline-gray-300 dark:outline-gray-700 border-gray-300 dark:border-gray-700 duration-200 border-r border-dashed ">
            <span className="drop-shadow duration-200 animate-popup">🌺</span>
          </div>
          <div className="h-16 text-3xl  cursor-default flex justify-center items-center outline-gray-300 dark:outline-gray-700 border-gray-300 dark:border-gray-700 duration-200 border-r border-dashed ">
            <span className="drop-shadow duration-200 animate-popup">🌻</span>
          </div>
          <div className="h-16 text-3xl  cursor-default flex justify-center items-center outline-gray-300 dark:outline-gray-700 border-gray-300 dark:border-gray-700 duration-200 border-r border-dashed bg-base-200">
            <span></span>
          </div>
          <div className="h-16 text-3xl  cursor-default flex justify-center items-center outline-gray-300 dark:outline-gray-700 border-gray-300 dark:border-gray-700 duration-200 border-r border-dashed ">
            <span></span>
          ...
          <div className="h-16 text-3xl  cursor-default flex justify-center items-center outline-gray-300 dark:outline-gray-700 border-gray-300 dark:border-gray-700 duration-200  ">
            <span></span>
          </div>
        </div>
      </div>
